...
$(function () {
  ...
  */
  ...
  var contactForm1 = new ProcessForm({idForm:'contactForm1',existenceUploadsFile:false,existenceCaptcha: false});
  contactForm1.init();

  var contactForm2 = new ProcessForm({idForm:'contactForm2',existenceUploadsFile:false,existenceCaptcha: false});
  contactForm2.init();

  var contactForm3 = new ProcessForm({idForm:'contactForm3',existenceUploadsFile:false,existenceCaptcha: false});
  contactForm3.init();

  var contactForm4 = new ProcessForm({idForm:'contactForm4',existenceUploadsFile:false,existenceCaptcha: false});
  contactForm4.init();

  var contactForm5 = new ProcessForm({idForm:'contactForm5',existenceUploadsFile:false,existenceCaptcha: false});
  contactForm5.init();

  var contactForm6 = new ProcessForm({idForm:'contactForm6',existenceUploadsFile:false,existenceCaptcha: false});
  contactForm6.init();

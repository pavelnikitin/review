    ...
    return (
      ...
      <div>
        ...
        <div className="row whatyouget text-center" id="_1">
          ...
          <div className="container-fluid">
            <div className="row whatyouget-description">
              <div
                className="col-xs-5 whatyouget-image"
                data-aos="fade-right"
              ...
              <div className="col-xs-7   whatyouget-list">
                <h6>
                  <div
                    className="whatyouget-text center-block"
                    data-aos="fade-left"
                    data-aos-easing="ease-in-sine"
                    data-aos-duration="600">
        ...
        <div className="row prepare text-center" id="_2">
          ...
          <div className="container-fluid">
            <div className="row prepare-description">
              <div
                className="col-xs-6 prepare-image"
                data-aos="fade-right"
                data-aos-easing="ease-in-sine"
                data-aos-duration="600">
              ...
              <div className="col-xs-6  prepare-description">
                <div
                  className="prepare-text"
                  data-aos="fade-left"
                  data-aos-easing="ease-in-sine"
                  data-aos-duration="600">
                  <span>Наши отзывы готовит группа сотрудников с различным стилем речи и написания
                    текста. Все тексты отзывов создаются индивидуально для каждого проекта с
                    уникальностью не менее 95%. Именно такие тексты вызывают доверие других
                    пользователей.</span>
                </div>
              </div>
            </div>
            ...
            <div className="row result-description">
              <div
                ...
                <img
                  src={resultimage}
                  alt="image"
                  className="img-responsive img-circle result-image"/>
              </div>
              <div
                className="col-xs-10 result-text"
                data-aos="fade-up-left"
                data-aos-easing="ease-in-sine"
                data-aos-duration="600">
                <span>
                  <p>Раньше никто в нашей компании не знал, что есть люди, у которых можно
                    заказать видео отзыв. Обходились своими силами. Мы тогда уже заметили, что
                    наличие такого отзыва повышает интерес к сайту.</p>
                  <p>Проблема была в том, что отзыва от клиента не допросишься. То у него времени
                    нет, то забыл. А многие просто стесняются говорить на камеру. Или не хотят
                    светиться в интернете. У нас висело 2 ролика 2-летней давности. Смотрелось это
                    грустно как-то.</p>
                  Когда мы узнали об этой услуге, то решили заказать видео отзывы. Взяли 10 штук.
                  Разместили на сайте. Конверсия сразу подросла. Мы за 2 года не могли такой
                  добиться. Выросло среднее время нахождения посетителя на сайте. То есть люди
                  реально смотрят эти видео. Заявки с контекстной рекламы стали обходиться нам на
                  30% дешевле. После этого заказали еще 30 фото отзывов с названием компании. Тоже
                  на сайте выложили и в соц. сетях. Очень хорошо они работают. Это заметно и по
                  числу заявок от клиентов, и по тем вопросам, которые они задают.
              ...
              <div className="col-xs-12 col-sm-10 col-sm-push-1">
                <div className="row">
                  <div className="col-xs-12 col-sm-4">
                    <div className="row">
                      <div
                        className="beginner col-xs-8 col-xs-push-2 text-center"
                        data-aos="flip-left"
                        data-aos-easing="ease-in-sine"
                        data-aos-duration="600">
                        <h3>«НАЧАЛЬНЫЙ»</h3>
                        <h2>
                          <span className="colorheader">10 000
                          </span>
                          руб</h2>
                        <h5>20 отзывов</h5>
                  ...
                  <div className="col-xs-12 col-sm-4">
                    <div className="row">
                      <div
                        className="standart col-xs-8 col-xs-push-2 text-center"
                        data-aos="flip-left"
                        data-aos-easing="ease-in-sine"
                        data-aos-duration="600"
                        data-aos-delay="300">
                        <h3>«СТАНДАРТНЫЙ»</h3>
                        <h2>
                          <span className="colorheader">17 000
                          </span>руб</h2>
                        <h5>50 отзывов</h5>
                        <h5 className="unicip">Экспресс анализ SEO</h5>
                        <div className="region center-block">
                  ...
                  <div className="col-xs-12 col-sm-4">
                    <div className="row">
                      <div
                        className="premium col-xs-8 col-xs-push-2 text-center"
                        data-aos="flip-left"
                        data-aos-easing="ease-in-sine"
                        data-aos-duration="600"
                        data-aos-delay="600">
                        <h3>«ПРЕМИУМ»</h3>
                        <h2>
                          <span className="colorheader">30 000</span>
                          руб</h2>
                        <h5>100 отзывов</h5>
                ...
                <div className="row">
                  <div
                    className="video col-xs-10 col-xs-push-1 col-sm-6 col-sm-push-3"
                    data-aos="zoom-in"
                    data-aos-easing="ease-in-sine"
                    data-aos-duration="600">
                    ...
                    <h2>
                      <span className="colorheader">5 000</span>
                      руб</h2>
                    <div className="video-description  center-block">
                      <h5>В некоторых нишах - этот отличный инструмент. Он показывает, что у вас
                        хороший опыт работы и много довольных клиентов.</h5>
        ...
        <div className="row  calculation">
          <h1 className="text-center">КАЛЬКУЛЯТОР</h1>
          <div className="col-xs-12 ">
            <div className="slash center-block"></div>
          </div>
          <div className="container-fluid">
        ...
        <div className="row contacts text-center" id="_6">
          <div className="contacts-overlay">
            ...
            <div
              className="contacts-form col-xs-10 col-xs-offset-1 col-sm-5 col-sm-offset-1">
            ...
            <div className="contacts-viber col-xs-12 col-sm-6">
              <div className="row contacts-phone text-right">
                <div className="col-xs-12 ">
                  <h3>
                    <div className="phonenumber">+7 555 555 55 55</div>
